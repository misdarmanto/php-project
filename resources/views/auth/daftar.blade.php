				...
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							...
							<form class="form-auth-small" action="/createaccount" method="POST">
								{{csrf_field()}}
								<div class="form-group">
									<label for="exampleInputEmail1" class="control-label sr-only">Email</label>
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">Sistem Repository Politeknik Pariwisata Batam</h1>
							<p>by Sandy</p>
						</div>
					</div>
