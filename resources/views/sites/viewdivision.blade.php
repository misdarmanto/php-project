		...
		<!-- start banner Area -->
			...
			<section class="popular-courses-area section-gap courses-page">
				<div class="container">
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-70 col-lg-8">
							<div class="title text-center">
								...
								<h1 class="mb-10">Data Repository by Division</h1>
					...
					@foreach ($author->repo as $repo)
					
						
					<a href ="{{url('/sites/viewrepository',$repo->id)}}"><font class="text-primary"> {{$repo->author->author}}</font>,- ({{$repo->year}}), <b><i>{{$repo->title}}</i></b>,- {{$repo->prodi->program_studi}}, </a>
